...
public class Activator extends AbstractUIPlugin {
     ...
     * The plug-in ID.
     */
    public static final String PLUGIN_ID = "ChangeTracker.Core";
    ...
    public void start(BundleContext context) throws Exception {
        ...
        RepositoryManager.getInstance().setDefaultLocation();
        RepositoryManager.getInstance().collectOperationsFromHistoryFiles();
    ...
    public void stop(BundleContext context) throws Exception {
        RepositoryManager.getInstance().getRepository().clear();
